...
import com.non.dozortest.database.Converters;
  ...
  public MovieDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMovie = new EntityInsertionAdapter<Movie>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `movies` (`id`,`original_title`,`overview`,`poster_path`,`release_date`,`vote_average`,`vote_count`,`isSaved`,`genre_ids`) VALUES (?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final String _tmp_1 = __converters.fromGenreList(entity.getGenreIds());
    ...
    this.__updateAdapterOfMovie = new EntityDeletionOrUpdateAdapter<Movie>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR REPLACE `movies` SET `id` = ?,`original_title` = ?,`overview` = ?,`poster_path` = ?,`release_date` = ?,`vote_average` = ?,`vote_count` = ?,`isSaved` = ?,`genre_ids` = ? WHERE `id` = ?";
      }
      ...
      public List<Movie> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpGenreIds = __converters.toGenreList(_tmp_1);
            _item = new Movie(_tmpId,_tmpOriginalTitle,_tmpDescription,_tmpPosterPath,_tmpReleaseDate,_tmpVoteAverage,_tmpVoteCount,_tmpIsSaved,_tmpGenreIds);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Movie call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp_1 = _cursor.getString(_cursorIndexOfGenreIds);
            _tmpGenreIds = __converters.toGenreList(_tmp_1);
            _result = new Movie(_tmpId,_tmpOriginalTitle,_tmpDescription,_tmpPosterPath,_tmpReleaseDate,_tmpVoteAverage,_tmpVoteCount,_tmpIsSaved,_tmpGenreIds);
          } else {
            _result = null;
          }
          return _result;
