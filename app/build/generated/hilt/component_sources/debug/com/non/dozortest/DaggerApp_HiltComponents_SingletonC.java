...
import com.non.dozortest.di.NetworkModule_ProvideApiServiceFactory;
import com.non.dozortest.di.NetworkModule_ProvideRetrofitFactory;
...
import com.non.dozortest.viewmodel.MainViewModel_HiltModules;
import com.non.dozortest.viewmodel.NetworkViewModel;
import com.non.dozortest.viewmodel.NetworkViewModel_HiltModules;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(LazyClassKeyProvider.com_non_dozortest_viewmodel_MainViewModel, MainViewModel_HiltModules.KeyModule.provide(), LazyClassKeyProvider.com_non_dozortest_viewmodel_NetworkViewModel, NetworkViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_non_dozortest_viewmodel_MainViewModel = "com.non.dozortest.viewmodel.MainViewModel";

      static String com_non_dozortest_viewmodel_NetworkViewModel = "com.non.dozortest.viewmodel.NetworkViewModel";

      @KeepFieldType
      MainViewModel com_non_dozortest_viewmodel_MainViewModel2;

      @KeepFieldType
      NetworkViewModel com_non_dozortest_viewmodel_NetworkViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.networkViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(LazyClassKeyProvider.com_non_dozortest_viewmodel_MainViewModel, ((Provider) mainViewModelProvider), LazyClassKeyProvider.com_non_dozortest_viewmodel_NetworkViewModel, ((Provider) networkViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.non.dozortest.viewmodel.MainViewModel 
          return (T) new MainViewModel(singletonCImpl.movieRepositoryProvider.get());

          case 1: // com.non.dozortest.viewmodel.NetworkViewModel 
          return (T) new NetworkViewModel();
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.non.dozortest.repository.MovieRepository 
          return (T) new MovieRepository(singletonCImpl.provideApiServiceProvider.get(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 1: // com.non.dozortest.network.ApiService 
