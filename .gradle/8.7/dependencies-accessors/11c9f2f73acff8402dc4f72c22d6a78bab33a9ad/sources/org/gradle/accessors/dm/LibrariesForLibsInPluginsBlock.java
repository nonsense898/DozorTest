...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class HazeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final HazeJetpackLibraryAccessors laccForHazeJetpackLibraryAccessors = new HazeJetpackLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>haze.jetpack</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public HazeJetpackLibraryAccessors getJetpack() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForHazeJetpackLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class HazeJetpackLibraryAccessors extends SubDependencyFactory {

        public HazeJetpackLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>dev.chrisbanes.haze:haze-jetpack-compose</b> coordinates and
         * with version reference <b>hazeJetpackCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("haze.jetpack.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final KaptVersionAccessors vaccForKaptVersionAccessors = new KaptVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>animationAndroid</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>core</b> with value <b>12.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>haze</b> with value <b>1.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hazeJetpackCompose</b> with value <b>0.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHazeJetpackCompose() { return getVersion("hazeJetpackCompose"); }
        ...
        /**
         * Version alias <b>kotlinxMetadataJvm</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>uiTooling</b> with value <b>1.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.kapt</b>
         */
        public KaptVersionAccessors getKapt() {
            return vaccForKaptVersionAccessors;
        }
    ...
    public static class KaptVersionAccessors extends VersionFactory  {

        public KaptVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>kapt.version</b> with value <b>2.0.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("kapt.version"); }
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>kapt.version</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
